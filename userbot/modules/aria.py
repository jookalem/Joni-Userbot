...
@joo_cmd(outgoing=True, pattern=r"^\.amag(?: |$)(.*)")
...
@joo_cmd(outgoing=True, pattern=r"^\.ator(?: |$)(.*)")
...
@joo_cmd(outgoing=True, pattern=r"^\.aurl(?: |$)(.*)")
...
@joo_cmd(outgoing=True, pattern=r"^\.aclear(?: |$)(.*)")
...
@joo_cmd(outgoing=True, pattern=r"^\.apause(?: |$)(.*)")
...
@joo_cmd(outgoing=True, pattern=r"^\.aresume(?: |$)(.*)")
...
@joo_cmd(outgoing=True, pattern=r"^\.ashow(?: |$)(.*)")
