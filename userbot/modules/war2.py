...
async def typewriter(typew):
    ...
    sleep(1.5)
    await typew.edit("**GAUSAH SOK KERAS DEH KONTOL**")
    sleep(1.5)
...
async def typewriter(typew):
    ...
    sleep(1)
    await typew.edit("**Anak Anjing Bedebah**")
    sleep(2)
    await typew.edit("**Alay Banget Lu Tolol**")
    sleep(2)
    await typew.edit("**Baru Pasang Ucelbot ya?**")
    sleep(2)
    await typew.edit("**Pantesan Norak yahaha**")
    sleep(2)
    await typew.edit("**Kalo Mau Coba-Coba Command Di Gc Botlog Aja Dongo**")
    sleep(2)
    await typew.edit("**Jangan Di Publik, Jijik Liatnya Anjing**")
    sleep(2)
    await typew.edit("**Intinya Lo Alay Maen Bot Mulu Kontol**")
    sleep(2)
...
async def typewriter(typew):
    ...
    sleep(2)
    await typew.edit("`Kosa Kata Pas Ngelawak, Jangan Di Pake War Dongo`")
    sleep(2)
    await typew.edit("`Kesannya Lo Ngasih Kita Hiburan Goblok`")
    sleep(2)
    await typew.edit(
        "`Kasian badut, Ga Di Hargain Pengunjung, Eh Lampiaskan Nya Ke Tele`"
    )
    sleep(3)
...
async def typewriter(typew):
    ...
    sleep(2)
    await typew.edit("**MUKALU KEK KONTOLL**")
    sleep(2)
    await typew.edit("**DASAR ANAK KONTOLLLL**")
    sleep(2)
    await typew.edit("**KONTOL LU BENGKOK KONTOL**")
    sleep(2)
    await typew.edit("**GAUSAH SO KEREN LU KONTOLL**")
    sleep(2)
    await typew.edit("**MUKA LU KEK MONYET BEKANTAN KONTOLLL**")
    sleep(2)
    await typew.edit("**ITEM DEKIL KEK PEMULUNG KONTOLL**")
    sleep(2)
    await typew.edit("**MENDING LU OPERASI KONTOLL**")
    sleep(2)
    await typew.edit("**BIAR GANTENG KONTOLL**")
    sleep(2)
